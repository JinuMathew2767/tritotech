        ...
        {tabs.map(({ id, label, to, icon: Icon }) => (
          <Link
            ...
            className={clsx(
              ...
              activeTab === id
                ? 'border-[#163b63] bg-[#163b63] text-white shadow-[0_12px_24px_-18px_rgba(22,59,99,0.35)]'
          ...
          >
            <div
              className={clsx(
                ...
                activeTab === id ? 'bg-white/12 text-white' : 'bg-slate-100 text-slate-500'
              )}
            >
            ...
            <div className="min-w-0 self-center">
              <p className={clsx('ui-card-title', compact ? 'text-[14px]' : 'text-[15px]', activeTab === id ? 'text-white' : 'text-slate-900')}>
                {label}
              </p>
            </div>
          </Link>

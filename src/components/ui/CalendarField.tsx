    ...
    renderPanel && !disabled
      ? createPortal(
          <div
            ...
            style={panelStyle}
            className={clsx(
              'origin-top transform-gpu overflow-hidden rounded-[24px] border border-white/70 bg-[linear-gradient(180deg,rgba(255,255,255,0.98)_0%,rgba(244,248,252,0.96)_100%)] p-2.5 shadow-[0_24px_60px_-30px_rgba(15,23,42,0.34)] backdrop-blur-xl transition duration-150 ease-out',
          ...
          >
            <div className="rounded-[20px] border border-white/75 bg-white/78 p-2.5 shadow-[inset_0_1px_0_rgba(255,255,255,0.75)]">
              <div className="flex items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-1.5">
                  <button
                    ...
                    className="flex h-9 w-9 items-center justify-center rounded-xl border border-white/70 bg-white/80 text-slate-500 shadow-sm transition-all hover:-translate-y-0.5 hover:text-slate-800"
                  >
              ...
              {mode === 'datetime' && (
                <div className="mt-2.5 flex items-center gap-2 rounded-xl border border-white/75 bg-slate-50/85 px-3 py-2">
              ...
              <div className="mt-3 flex items-center justify-between gap-3 border-t border-slate-100 pt-2.5">
                <button
                  type="button"
                  onClick={handleToday}
                  className="rounded-xl bg-[#4E5A7A]/8 px-3 py-1.5 text-xs font-semibold text-[#4E5A7A] transition-colors hover:bg-[#4E5A7A]/12"
                >
                ...
                <div className="flex items-center gap-2">
                  ...
                  {mode === 'datetime' && (
                    <button
                      ...
                      className="rounded-xl bg-[linear-gradient(135deg,#5b6785_0%,#434e69_100%)] px-3 py-1.5 text-xs font-semibold text-white shadow-[0_14px_26px_-18px_rgba(78,90,122,0.5)]"
                    >
                      Done
                    </button>
                  )}

...
export default function Modal({ open, onClose, title, children, size = 'md' }: ModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className={clsx('relative w-full overflow-hidden rounded-[26px] border border-white/65 bg-[linear-gradient(180deg,rgba(255,255,255,0.92)_0%,rgba(246,250,253,0.84)_100%)] shadow-[0_36px_90px_-42px_rgba(15,23,42,0.65)] backdrop-blur-2xl', sizeMap[size])}>
